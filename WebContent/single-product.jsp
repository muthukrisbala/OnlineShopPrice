                                    ...
                                    <div class="product-images-wrapper">
                                        ...
                                        <div class="images electro-gallery">
                                            <div class="thumbnails-single owl-carousel">
                                                <a href="assets/images/vivo-y69-1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg1" /> data-echo=<s:property value="fp_fullimg1" /> class="wp-post-image" alt=""></a>

                                                <a href="images/single-product/s1.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg2" /> data-echo=<s:property value="fp_fullimg2" /> class="wp-post-image" alt=""></a>

                                                <a href="images/single-product/s2.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg3" /> data-echo=<s:property value="fp_fullimg3" /> class="wp-post-image" alt=""></a>

                                                <a href="images/single-product/s3.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg4" /> data-echo=<s:property value="fp_fullimg4" /> class="wp-post-image" alt=""></a>

                                                <a href="images/single-product/s4.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg5" /> data-echo=<s:property value="fp_fullimg5" /> class="wp-post-image" alt=""></a>

                                                <a href="images/single-product/s5.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]"><img src=<s:property value="fp_fullimg6" /> data-echo=<s:property value="fp_fullimg6" /> class="wp-post-image" alt=""></a>
                                            </div><!-- .thumbnails-single -->

                                            <div class="thumbnails-all columns-5 owl-carousel">
                                                <a href="images/single-product/single-thumb1.jpg" class="first" title=""><img src=<s:property value="fp_thumbimg1" /> data-echo=<s:property value="fp_thumbimg1" /> class="wp-post-image" alt=""></a>
